...
class ProcessingStrategyProvider:
    ...
    def register_strategy(self, region_type: str, strategy_class: Type[ProcessingStrategy]) -> None:
        """
    ...
    def get_strategy(self, region_type: str, config: Dict[str, Any] = None) -> ProcessingStrategy:
        """
